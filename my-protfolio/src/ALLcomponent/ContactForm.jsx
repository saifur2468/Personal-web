...
//       <div className="max-w-7xl w-full grid grid-cols-1 lg:grid-cols-2 gap-12 bg-white rounded-xl shadow-lg p-10">
...
//               <p className="font-semibold text-gray-800">New York</p>
...
//             <div className="bg-white border border-yellow-400 rounded-lg p-6 hover:shadow-md transition">
//               <div className="text-yellow-500 text-3xl mb-2">📞</div>
//               <p className="font-semibold text-gray-800">+017256015</p>
...
//             <div className="bg-white border border-yellow-400 rounded-lg p-6 hover:shadow-md transition">
//               <div className="text-yellow-500 text-3xl mb-2">💵</div>
//               <p className="font-semibold text-gray-800">35$/hr</p>
...
//             <button
//               type="submit"
//               className="w-full bg-yellow-500 hover:bg-yellow-400 text-white font-semibold py-3 rounded-md transition"
//             >
//               Send Message
//             </button>
//           </form>
